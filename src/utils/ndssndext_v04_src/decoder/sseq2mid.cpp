                  ...
                  if(offsetToJump >= sseq2mid->track[trackIndex].offsetToTop)
                  {
                    if(offsetToJump < curOffset)
                    {
                      ...
                      case 2:
                        if(!loopPointUsed)
                        {
                            smfInsertMetaEvent(smf, sseq2mid->track[trackIndex].offsetToAbsTime[offsetToJump], midiCh, 6, (byte*)"loopStart", 9);
                            smfInsertMetaEvent(smf, absTime, midiCh, 6, (byte*)"loopEnd", 7);
                            loopPointUsed = true;
                        }
                        loopCount = 0;
                        break;
                  ...
                  if(loopStartCount==0)
                  {
                      ...
                      if(!loopStartPointUsed)
                      {
                          ...
                          case 1:
                              ...
                              break;
                          case 2:
                              smfInsertMetaEvent(smf, absTime, midiCh, 6, (byte*)"loopStart", 9);
                              break;
                          }
...
bool sseq2midWriteMidiFile(Sseq2mid* sseq2mid, const char* filename)
{
